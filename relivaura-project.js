...
const RELIVAURA_PROJECT = {
  ...
  type:"Shopify wellness e-commerce store",
  tools:"Shopify, Theme Editor, E-commerce UX",
  year:"2026",
  challenge:"Designed and configured a Shopify wellness storefront around Relivaura FlexiKnee Pro. The customer journey moves from a benefit-led landing experience to a focused product page with pricing, quantity selection, purchase CTA, delivery/return reassurance and cart interaction. The portfolio presentation documents the implemented storefront and UX without treating product marketing claims or unverified conversion results as proven outcomes.",
