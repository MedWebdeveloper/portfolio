...
const JADELYA_PROJECT = {
  ...
  type:"Shopify beauty e-commerce store",
  tools:"Shopify, Theme Editor, E-commerce UX",
  year:"2026",
  challenge:"Designed and configured a beauty-focused Shopify storefront for Jadélya SculptLift. The experience combines brand storytelling, a conversion-focused product page, clear product benefits, quantity and cart interactions, delivery and return information, FAQ content and a streamlined path toward checkout. The portfolio presentation focuses on the implemented storefront and customer journey without claiming unverified conversion or sales uplift.",
